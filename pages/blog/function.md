...
以下功能的示例语句仅供参考，Amiya 采用了 Chino Smart Identification™关键词识别技术，会识别句子成分并自动选择功能，不需要严格按照格式使用
:::

::: danger 警告<br>
**禁言会导致 Amiya 退群！！！**<br>
因框架机制的原因，新进的群员可能会在一段时间内无法唤起 Amiya，请耐心等候 Amiya 刷新或主动重新登录 Mirai 登录的 QQ 账号<br>
由于目前仍未有简单可靠的方式稳定的获取中文配音，Amiya 在未来一段时间内将不会支持中文配音，直到前文所述前提条件已达成
:::
...
- 发送 `阿米娅` 或`戳一戳`，Amiya 会随机回复`表情包`、`语音`或`戳一戳`
- 发送 `阿米娅签到` 可以进行每日签到
- 除上述之外，Amiya 会也根据自然语言处理回复部分**不能触发任何功能的语句**

## 查看个人信息

- 发送 `阿米娅查看我的信息` 查看你的个人信息
...
:::tip 提示
设置的别名并不仅限于干员和物品，理论上，别名可以代替任何输入<br>
例如：你可以将爱国者的别名设为大爹
:::
...
:::tip 提示
你可以尝试利用业界领先的 Chino Smart Identification™关键词识别技术花样抽卡<br>
例如：`阿米娅，赌上我的一切，来吧！十连！`<br>
等效于`阿米娅十连`
:::
...
::: warning 请注意<br>
阿米娅支持当微博动态更新时主动推送到群，但为避免打扰，此功能需要授权才可开启推送，可联系 Amiya 的管理员获得授权（免费）
:::
